...
# Iterate
isonet.py refine RAW_subtomo.star --gpuID 0,1 --iterations 30 --result_dir RAW_results --noise_level 0.05,0.1,0.15 --noise_start_iter 15,20,25 --batch_size 16 --learning_rate 0.0005

# predict the rest of the tomograms
# isonet.py prepare_star RAW_allTomos --output_star RAW_allTomos.star --pixel_size 14.08
