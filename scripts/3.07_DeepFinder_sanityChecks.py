...
weight_decay = 0
Lrnd = 0
tensorboard_logdir = os.path.join(PARENT_PATH, 'model_sanityChecks/logs/one_patch_training_ddp/')
...
trainer_1patch.launch(train_tomos, val_tomos, input_type='cryoCARE', num_gpus=3, accelerator='ddp',
                        num_workers=1, dataset=dl.tomoSegment_dataset)
